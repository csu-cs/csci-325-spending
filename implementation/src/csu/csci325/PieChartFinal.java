...
public class PieChartFinal extends JPanel {
    ...
    public PieChartFinal(int percent) {

        type = Type.SIMPLE_INDICATOR;
        this.percent = percent;
    }

    public PieChartFinal(ArrayList values, ArrayList colors) {
    ...
    public PieChartFinal(int percent, ArrayList gradingValues, ArrayList gradingColors) {
